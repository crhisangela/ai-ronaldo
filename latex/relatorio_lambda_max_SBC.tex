...
A Figura \ref{fig:eda} mostra a distribuição do $\lambda_{max}$ experimental no Deep4Chem, concentrada majoritariamente entre 300 e 500 nm, com uma cauda longa até a região de infravermelho próximo, e os 10 solventes mais frequentes, liderados por diclorometano (\texttt{ClCCl}), o que motiva sua escolha como solvente de referência constante na Etapa 2 (Seção 2.5).
